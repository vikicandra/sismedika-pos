...
class TableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Table::create(['name' => '10', 'status' => 'occupied']);
        Table::create(['name' => '11', 'status' => 'reserved']);
        Table::create(['name' => '12', 'status' => 'inactive']);
        ...
        Table::create(['name' => '20', 'status' => 'available']);
        Table::create(['name' => '21', 'status' => 'occupied']);
        Table::create(['name' => '22', 'status' => 'reserved']);
        Table::create(['name' => '23', 'status' => 'inactive']);
        Table::create(['name' => '24', 'status' => 'available']);
    }
}
