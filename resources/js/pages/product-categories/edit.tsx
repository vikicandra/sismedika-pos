...
export default function ProductCategoryEdit({ productCategory }: { productCategory: ProductCategory }) {
    const { data, setData, put, errors, processing } = useForm({
        ...
        const submit: FormEventHandler = (e) => {
            e.preventDefault();
            put(productCategoriesRoutes.update.url({ product_category: productCategory.id }));
        };
...
ProductCategoryEdit.layout = (page: React.ReactNode) => <AppLayout breadcrumbs={breadcrumbs}>{page}</AppLayout>;
